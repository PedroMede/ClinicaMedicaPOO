 ...
 * @author igor-
 */
public class CadastroSecretFunc extends javax.swing.JFrame {

    /**
     * Creates new form CadastroMedicoFunc
     */
    public CadastroSecretFunc() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("3° passo é cadastras as informações de trabalho do médico:");
        ...
        jLabel2.setText("Nr° da carteira de trabalho");
        ...
        jLabel6.setText("Usuário de login");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroSecretFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroSecretFunc().setVisible(true);
            }
        });
    }
