 ...
 * @author igor-
 */
public class CadastroMedicoFunc extends javax.swing.JFrame {

    /**
     * Creates new form CadastroMedicoFunc
     */
    public CadastroMedicoFunc() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroMedicoFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroMedicoFunc().setVisible(true);
            }
        });
    }
